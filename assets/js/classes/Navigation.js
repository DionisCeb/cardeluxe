class Navigation {
    ...
    toggleMenu() {
        if (this.dropDownMenu.classList.contains("open")) {
            this.closeMenu();
            this.updateImages("https://img.icons8.com/?size=100&id=36389&format=png&color=808080");
        } else {
            this.openMenu();
            this.updateImages("https://img.icons8.com/?size=100&id=46&format=png&color=808080");
        }
    }
